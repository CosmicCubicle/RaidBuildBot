...
describe("retry utility function", function () {
    var _this = this;
    it("throws an exception if we reach the maximum retries", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it("returns the value if resolved on time", function () { return __awaiter(_this, void 0, void 0, function () {
        var result;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
