...
const ValidServerApiVersions = require('mongodb/lib/core').ValidServerApiVersions;
...
function MongoClient(url, options) {
  ...
  if (options.autoEncryption) require('mongodb/lib/encrypter'); // Does CSFLE lib check
