...
const Long = require('mongodb/lib/core').BSON.Long;
const MongoError = require('mongodb/lib/core').MongoError;
const ObjectID = require('mongodb/lib/core').BSON.ObjectID;
const BSON = require('mongodb/lib/core').BSON;
const MongoWriteConcernError = require('mongodb/lib/core').MongoWriteConcernError;
const emitWarningOnce = require('mongodb/lib/utils').emitWarningOnce;
...
const hasAtomicOperators = require('mongodb/lib/utils').hasAtomicOperators;
